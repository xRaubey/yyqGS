...
/*
    Change user profile image functionality.
 */


/*
    Set the size of profile image.
 */
...
$('.my-image').parent().addClass("row p-0 m-0 justify-content-center col-12 align-content-center")
    .append("<div class='col-12 row p-0 m-0 justify-content-around' id='svg_container'></div>");
...
$("#svg_container")
    .append("<svg id='choose_profile' class='align-self-center' width=\"55\" height=\"55\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
        ...
        .append("<svg id='gb' width=\"55\" height=\"55\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
            ...
            "  <path stroke=\"null\" id=\"svg_2\" d=\"m39.890766,35.923571l-8.375668,-8.536673l8.374145,-8.536673l-4.305051,-4.390909l-8.375668,8.536673l-8.375668,-8.536673l-4.305051,4.390909l8.374145,8.536673l-8.375668,8.536673l4.308095,4.389358l8.374145,-8.536673l8.374145,8.536673\" fill-opacity=\"null\" stroke-opacity=\"null\" stroke-width=\"0.2\" fill=\"#456\"/>\n" +
            " </g>\n" +
            "</svg>");
...
$(window).on("load", function() {
    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                // $('.cr-image').croppie('bind',{url: e.target.result});




                // $('.croppie-container').on('update.croppie', function(ev, cropData) {});


            };

            var data = reader.readAsDataURL(input.files[0]);
    ...
    //                     location.href="/yyqGS/public/personal_center.php?id="+data.id;
    //                 }
    //                 else{
    //
